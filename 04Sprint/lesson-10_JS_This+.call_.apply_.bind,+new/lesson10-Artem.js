...
//             }
//         )() // что это за синтаксис? Это самовызывающаяся функция. Почему она нужна? 
//         // Потому что у стрелочной функции нет своего лексического окружения, поэтому this будет ссылаться на объект window, а в объекте window нет свойства color
//     }
// }
//
// car.showColor()
...
//-------------------------------------------------------------------------------------------------
// 3. call / apply / bind
// call - вызывает функцию с указанным this и аргументами. То есть можно вызвать эту функцию именно в контексте или имени другого объекта.
// apply - вызывает функцию с указанным this и аргументами в виде массива. Единственное отличие от call в том, что аргументы передаются в виде массива. А у call аргументы передаются через запятую.
const car1 = {
    brand: 'bmw',
